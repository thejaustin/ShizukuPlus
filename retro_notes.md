...
- **Intelligent App Detection**: Dynamic UI highlighting for **MacroDroid**, **Tasker**, **Hex Installer**, and other integrated tools.
- **Functional CLI Bridge**: The `plus` CLI helper provides full terminal control over Microdroid VMs and privileged storage.

### 🛠️ Core Optimizations
- **Transparent Shell Interceptor**: High-performance native API routing for `am`, `pm`, and `settings` commands.
